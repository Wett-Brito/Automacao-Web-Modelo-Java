...
import br.com.safra.automation.selenium.core.config.DriverSetup;
...
public enum DriverType implements DriverSetup
{
    ...
    CHROME {
        public RemoteWebDriver getWebDriverObject(DesiredCapabilities capabilities) {
            ...
            ChromeDriverService service = new ChromeDriverService.Builder().usingDriverExecutable(new File("C:\\Dev\\drivers\\chromedriver.exe")).usingAnyFreePort().build();
